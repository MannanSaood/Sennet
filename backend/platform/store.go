...
func Open(dsn string) (*Store, error) {
	...
	schema := []string{
		...
		`CREATE TABLE IF NOT EXISTS platform_finance_reconciliation (tenant TEXT NOT NULL,source_id TEXT NOT NULL,account_id TEXT NOT NULL,transaction_id TEXT NOT NULL,rule_version TEXT NOT NULL,state TEXT NOT NULL,currency TEXT NOT NULL,amount TEXT NOT NULL,last_sequence BIGINT NOT NULL,event_watermark BIGINT NOT NULL,receive_watermark BIGINT NOT NULL,updated BIGINT NOT NULL,PRIMARY KEY(tenant,source_id,account_id,transaction_id,rule_version))`,
		`CREATE TABLE IF NOT EXISTS platform_finance_conclusions (tenant TEXT NOT NULL,conclusion_key TEXT NOT NULL,source_id TEXT NOT NULL,account_id TEXT NOT NULL,transaction_id TEXT NOT NULL,rule_version TEXT NOT NULL,kind TEXT NOT NULL,severity TEXT NOT NULL,event_ids TEXT NOT NULL,detail TEXT NOT NULL,created BIGINT NOT NULL,PRIMARY KEY(tenant,conclusion_key))`,
		`CREATE INDEX IF NOT EXISTS platform_finance_queue ON platform_finance_conclusions(tenant,created,conclusion_key)`,
		`CREATE TABLE IF NOT EXISTS platform_finance_sources (tenant TEXT NOT NULL,source_id TEXT NOT NULL,account_id TEXT NOT NULL,last_sequence BIGINT NOT NULL,event_watermark BIGINT NOT NULL,receive_watermark BIGINT NOT NULL,gap_count BIGINT NOT NULL,updated BIGINT NOT NULL,PRIMARY KEY(tenant,source_id,account_id))`,
		`CREATE TABLE IF NOT EXISTS platform_cloud_costs (tenant TEXT NOT NULL,provider TEXT NOT NULL,source_id TEXT NOT NULL,account_id TEXT NOT NULL,period_start TEXT NOT NULL,period_end TEXT NOT NULL,service TEXT NOT NULL,region TEXT NOT NULL,amount TEXT NOT NULL,currency TEXT NOT NULL,charge_kind TEXT NOT NULL,workload_identity_id TEXT NOT NULL,provider_request_id TEXT NOT NULL,ingested BIGINT NOT NULL,PRIMARY KEY(tenant,provider,source_id,account_id,period_start,service,region,charge_kind))`,
		`CREATE TABLE IF NOT EXISTS platform_cloud_checkpoints (tenant TEXT NOT NULL,provider TEXT NOT NULL,source_id TEXT NOT NULL,account_id TEXT NOT NULL,period_start TEXT NOT NULL,period_end TEXT NOT NULL,page_token TEXT NOT NULL,status TEXT NOT NULL,provider_request_id TEXT NOT NULL,updated BIGINT NOT NULL,PRIMARY KEY(tenant,provider,source_id,account_id))`,
		`CREATE TABLE IF NOT EXISTS platform_cost_allocations (tenant TEXT NOT NULL,allocation_key TEXT NOT NULL,provider TEXT NOT NULL,account_id TEXT NOT NULL,period_start TEXT NOT NULL,currency TEXT NOT NULL,amount TEXT NOT NULL,record_kind TEXT NOT NULL,rule_id TEXT NOT NULL,rule_version TEXT NOT NULL,target TEXT NOT NULL,source_keys TEXT NOT NULL,created BIGINT NOT NULL,PRIMARY KEY(tenant,allocation_key))`,
		`INSERT INTO platform_schema(version) VALUES(4) ON CONFLICT(version) DO NOTHING`,
	}
